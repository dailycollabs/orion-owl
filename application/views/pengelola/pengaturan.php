...
$(document).ready(function(){
    ...
    function getpetugasData(){
        ...
        $.ajax({
            type : "GET",
            url  : "<?php echo base_url('superadmin/Pengaturan/getPengaturanWaktu')?>",
            dataType : "JSON",
            success : function(data){
                ...
                for(i=0; i<data.length; i++){
                    html += "<tr>"+
                            "<td>"+ n++ +"</td>"+
                            "<td>"+data[i].waktu+"</td>"+
                            "<td style='text-align:center'><button class='btn btn-info' id='btn-detail' value='"+data[i].pengaturanID+"'>Detail</button> <button class='btn btn-primary' id='btn-edit' value='"+data[i].pengaturanID+"'>Edit</button> <button class='btn btn-danger' id='btn-delete' value='"+data[i].pengaturanID+"'>Delete</button></td>"+
                            "</tr>";
                }
