            ...
            success : function(data){
                ...
                for(i=0; i<data.length; i++){
                    html += "<tr>"+
                            ...
                            "<td style='text-align:center'><a href='<?=base_url('IntHonorarium/konfBudgetHonor/')?>"+data[i].budgethonorID+"'><button class='btn btn-primary btn-sm'>konfirmasi</button></a></td>"+
                            "</tr>";
                }
