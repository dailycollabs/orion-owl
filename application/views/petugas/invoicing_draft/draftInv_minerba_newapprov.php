            ...
            success : function(data){
                ...
                for(i=0; i<data.length; i++){
                    html += "<tr>"+
                            ...
                            "<td>"+data[i].waktu+"</td>"+
                            "<td style='text-align:center'><a href='<?=base_url('InvoicingDraft/konfirmasiInvMin/')?>"+data[i].invDetailID+"'><button class='btn btn-primary btn-sm'>Konfirmasi</button></a></td>"+
                            "</tr>";
