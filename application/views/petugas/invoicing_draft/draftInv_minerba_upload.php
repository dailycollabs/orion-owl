                                    ...
                                    <div class="card">
                                        <div class="card-header bg-dark">
                                            <div class="d-flex justify-content-between">
                                                <div class="card-title">UPLOAD INVOICING DRAFT MINERBA</div>
                                                <div id="waktuTimeout" class="card-title"></div>
                                            </div>
                                        </div>
                                        
                                        <div class="card-body">
                                        <td><input type="hidden" id="frMinDetailID" value="<?=$row->invMin_frDetailID?>"></td>
                                        ...
                                        <form action="" id="formAdd">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden" name="bidangID" class="form-control bidangID" id="bidangID" value="<?=$row->invMin_bidangID?>" >
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden" name="invID" id="invID" class="form-control"  value="<?=$row->invMinID?>">
                                                    <input type="text" name="invNo" id="invNo" class="form-control"  value="<?=$row->invMinNo?>">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="commentINVMIN" id="commentINVMIN" class="form-control" cols="10" rows="5"></textarea>
...
$(document).ready(function(){
    ...
    $('#add').on('click', function(e){
        ...
        myformData.append('commentINVMIN', $("#commentINVMIN").val());
