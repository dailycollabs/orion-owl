                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body p-0">
                                            <input type="hidden" id="frMinDetailID" value="<?=$row->frMinDetailID?>">
                                            ...
                                            <thead>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><?=$row->frMinD_frID?></td>
                                                    </tr>
                                                    <tr>
                                                        <th>NO LHV</th>
                                                        <td><?=$row->frMinlhvNo?></td>
                                                    </tr>
                                                    <tr>
                                                        <th>NO SPK</th>
                                                        <td><?=$rowSPK->spkNo?></td>
                                ...
                                <?php if($rowINV == null){?>
                                    <div class="card">
                                        <div class="card-header bg-dark">
                                            <div class="card-title">
                                                <span>Create Draft Invoice Minerba</span>
                                            </div>
                                        </div>
                                        <div class="card-body">
                                        <form action="" id="formAdd">
                                                
                                                    <input type="hidden" name="frDetailID" class="form-control lhvID" id="exampleInputEmail1" value="<?=$row->frMinDetailID?>" >
                                                    <input type="hidden" name="spkID" class="form-control lhvID" id="exampleInputEmail1" value="<?=$row->frMin_spkID?>" >
                                                    <input type="hidden" name="jobdescID" class="form-control" id="exampleInputEmail1" value="<?=$row->frMin_jobdaDetailID?>">
                                                    <input type="hidden" name="quoDetailID" class="form-control" id="exampleInputEmail1" value="<?=$row->frMin_quoDetailID?>">
                                                    <input type="hidden" name="orderID" class="form-control lhvID" id="exampleInputEmail1" value="<?=$row->frMin_orderID?>" >
                                      
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">bidang</label>
                                                    <input type="hidden" name="bidangID" class="form-control lhvID" id="bidangID" value="<?=$row->frMin_bidangID?>" >
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="frID" class="form-control frID" id="exampleInputEmail1" value="<?=$row->frMinD_frID?>">
                                                </div>
                                               
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">No Invoice</label>
                                                    <input type="text" name="invNo" class="form-control invID" id="invNo" value="">
                                                    <span class="invID_error text-danger"></span>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">No Reference</label>
                                                    <input type="text" name="referencingNo" class="form-control referencingNo" id="referencingNo" value="" >
                                                    <span class="referencingID_error text-danger"></span>
                                                </div>

                                                <button type="reset" class="btn btn-secondary">Reset</button>
                                                <button type="submit" id="add" name="add" class="btn btn-primary">Upload Draft</button>
                                    ...
                                    <?php if($rowInvDetail == null){?>
                                        ...
                                        <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="invID" class="form-control lhvID" id="invID" value="<?=$rowINV->invMinID?>" >
                                                </div>
