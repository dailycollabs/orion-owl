                                    ...
                                    <div class="card">
                                        <div class="card-header bg-dark">
                                            <div class="card-title">
                                                <span>Upload Quotation <?=$rowData?></span>
                                            </div>
                                        </div>
                                        ...
                                        <form action="" id="formAdd">
                                                ...
                                                <!-- <input type="text" name="success" id="send_up" value="success"> -->
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" name="quoFile" class="form-control quoFile" id="quoFile" required>
                                                    <span class="quoFile_error text-danger"></span>
                                               
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Comment</label>
                                                    <textarea name="quoComment" id="" class="form-control" cols="10" rows="5"></textarea>
