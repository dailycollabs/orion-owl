                ...
                for(i=0; i<data.length; i++){
                    if(data[i].status == 'failed'){
                        html += "<tr>"+
                            ...
                            "<td style='text-align:center'><a href='<?=base_url('WorkflowQuotation/rkadetailFailed/')?>"+data[i].detailRkaID+"'><button id='btn-detail' class='btn btn-info btn-sm'>Detail</button> </a><a href='<?=base_url('IntAdministrasi/revisiSuratMasuk/')?>"+data[i].smID+"'><button class='btn btn-primary btn-sm'>create Revisi</button></a></td>"+
                            "</tr>";
