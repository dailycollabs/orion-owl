                ...
                <div class="container-fluid" style="max-width: 100%;">
                    ...
                    <div class="card">
                        <div class="card-header bg-dark">
                            ...
                            <span>Failed Draft Final Report</span>
                            </div>
                        </div>
                        <div class="card-body">
            ...
            success : function(data){
                ...
                for(i=0; i<data.length; i++){
                    ...
                    html += "<tr>"+
                            ...
                            "<td style='text-align:center'><a href='<?=base_url('InvoicingFinalReport/revisiDraftFR/')?>"+data[i].frDetailID+"'><button class='btn btn-primary btn-sm'>create Revisi</button></a></td>"+
                            "</tr>";
                    }
