                                    ...
                                    <div class="card">
                                        <div class="card-header bg-dark">
                                            <div class="d-flex justify-content-between">
                                                <div class="card-title">Upload List Breakdown</div>
                                        ...
                                        <div class="card-body">
                                            <form action="" id="formAdd">
                                                ...
                                                <input type="hidden" name="add_new" class="form-control" id="add_new" value="add_new">
                                                ...
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">NO Breakdown</label>
                                                    <input type="text" name="breakdownID" id="breakdownID" class="form-control"  value="<?=$row->breakdownlistID?>" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">File Breakdown</label>
                                                    <input type="file" name="breakdownFile" class="form-control quoFile" id="breakdownFile" required>
                                                    <span class="quoFile_error text-danger"></span>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Comment</label>
                                                    <textarea name="breakdownComment" id="breakdownComment" class="form-control" cols="10" rows="5"></textarea>
                                                </div>
