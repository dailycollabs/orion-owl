...
$(document).ready(function(){
    ...
    function getNewOrder(){
        ...
        $.ajax({
            type : "GET",
            url  : "<?php echo base_url('IntPengadaanBarang/getNewNotaDinas')?>",
            dataType : "JSON",
            success : function(data){
                ...
                for(i=0; i<data.length; i++){
                    html += "<tr>"+
                            ...
                            "<td>"+data[i].status+"</td>"+
                            "<td>"+data[i].nd_pengirimID+"</td>"+
                            "<td>"+data[i].ndWaktu+"</td>"+
                            "<td style='text-align:center'><a href='<?=base_url('IntPengadaanBarang/konfNotaDinas/')?>"+data[i].notadinasID+"'><button class='btn btn-primary btn-sm'>konfirmasi</button></a></td>"+
                            "</tr>";
                }
