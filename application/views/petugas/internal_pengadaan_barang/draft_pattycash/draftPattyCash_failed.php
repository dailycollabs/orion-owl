                ...
                for(i=0; i<data.length; i++){
                    if(data[i].status == 'failed'){
                        html += "<tr>"+
                            ...
                            "<td style='text-align:center'><a href='<?=base_url('IntPengadaanBarang/revisiPettyCash/')?>"+data[i].pattycashID+"'><button class='btn btn-primary btn-sm'>create Revisi</button></a></td>"+
                            "</tr>";
                    }
