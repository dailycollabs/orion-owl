                ...
                <div class="container-fluid" style="max-width: 100%;">
                    ...
                    <div class="card">
                        <div class="card-header bg-dark">
                            ...
                            <span>FAILED LAPORAN BELANJA</span>
                            </div>
                        </div>
                        <div class="card-body">
...
$(document).ready(function(){
    ...
    function getNewOrder(){
        ...
        $.ajax({
            type : "GET",
            url  : "<?php echo base_url('IntPengadaanBarang/getNewFailedLaporanBelanja')?>",
            dataType : "JSON",
                ...
                for(i=0; i<data.length; i++){
                    if(data[i].status == 'failed'){
                        html += "<tr>"+
                            ...
                            "<td style='text-align:center'><a href='<?=base_url('IntPengadaanBarang/revisiLaporanBelanja/')?>"+data[i].lbDetailID+"'><button class='btn btn-primary btn-sm'>create Revisi</button></a></td>"+
                            "</tr>";
                    }
                }
