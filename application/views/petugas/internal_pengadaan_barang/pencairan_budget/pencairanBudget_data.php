                ...
                <?php } ?>
                    ...
                    <div class="card">
                        <div class="card-header bg-dark">
                            ...
                            <span>DATA Pencairan Budget</span>
                            </div>
                        </div>
                        <div class="card-body">
...
$(document).ready(function(){
    ...
    function getNewOrder(){
        ...
        $.ajax({
            type : "GET",
            url  : "<?php echo base_url('IntPengadaanBarang/getDataPencairanBudget')?>",
            dataType : "JSON",
            success : function(data){
                ...
                for(i=0; i<data.length; i++){
                    html += "<tr>"+
                            ...
                            "<td style='text-align:center'><a href='<?=base_url('IntPengadaanBarang/konfPencairanBudget/')?>"+data[i].pencairanbudgetID+"'><button id='btn-detail' class='btn btn-info btn-sm'>Detail</button> </td>"+
                            "</tr>";
                }
